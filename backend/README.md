...
## Project Structure
    ...
    ├── testapiautodatamod_106682  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_106682`
...
2. Clone this repo and `cd testapiautodatamod_106682`
